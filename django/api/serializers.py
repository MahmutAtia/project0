...
class ResumeSerializer(serializers.ModelSerializer):
    ...
    def get_generated_documents_data(self, obj: Resume): # Renamed method
        ...
        if hasattr(obj, 'generated_documents'): # Check if prefetch_related was used
            ...
            return GeneratedDocumentSerializer(documents, many=True, context=self.context).data
        return []
    def get_personal_website_uuid(self, obj: Resume):
        ...
        except GeneratedWebsite.DoesNotExist: # Should be caught by hasattr check if prefetch_related is used
            pass
