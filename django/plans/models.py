...
class Plan(models.Model):
    ...
    billing_period = models.CharField(max_length=20, choices=BILLING_PERIODS, default='monthly')  # Changed from billing_cycle
    is_active = models.BooleanField(default=True)
    ...
    features = models.JSONField(default=list, blank=True)  # For storing feature list as JSON
