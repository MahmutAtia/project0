    ...
    def handle(self, *args, **options):
        ...
        plans_data = [
            {
                ...
                'is_free': True,
                'features': ['3 AI Resumes', '5 Resume Edits', '5 PDF Downloads', '1 Website', '2 Documents', '3 ATS Checks'],
                'is_popular': False
            },
            {
                'name': 'Pro Plan',
                ...
                'billing_period': 'monthly',
                'is_free': False,
                'features': ['Unlimited Resumes', 'Unlimited Edits', 'Unlimited PDFs', 'Unlimited Websites', 'Unlimited Documents', 'Unlimited ATS Checks', 'Priority Support'],
                'is_popular': True
            },
            {
                ...
                'is_free': False,
                'features': ['Unlimited Resumes', 'Unlimited Edits', 'Unlimited PDFs', 'Unlimited Websites', 'Unlimited Documents', 'Unlimited ATS Checks', 'Priority Support', '2 Months Free'],
                'is_popular': False
            }
        ]
        ...
        for plan_name, limits in feature_limits.items():
            try:
                ...
                self.stdout.write(
                    self.style.WARNING(f'Plan not found: {plan_name}')
                )
        
        self.stdout.write(
            self.style.SUCCESS(f'Successfully created {len(created_plans)} new plans with feature limits')
        )