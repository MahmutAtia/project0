...
from .prompts import global_edit_prompt, ats_create_resume_prompt, ats_job_desc_resume_prompt, edit_resume_section_prompt, ats_checker_prompt, ats_checker_no_job_desc_prompt
...
global_edit_chain = chain_instance.build_chain(global_edit_prompt)
